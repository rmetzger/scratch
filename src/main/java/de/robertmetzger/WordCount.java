...
public class WordCount {
	 ...
	 */
	public static final class LineSplitter implements FlatMapFunction<Tuple2<LongWritable, Text>, Tuple2<String, Integer>> {

		@Override
		public void flatMap(Tuple2<LongWritable, Text> value, Collector<Tuple2<String, Integer>> out) {
			// normalize and split the line
			String[] tokens = value.f1.toString().toLowerCase().split("\\W+");
